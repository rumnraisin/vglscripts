...
$( document ).ready(function() {
	...
	/* Tabs */ {
		...
		if(!Array.isArray(calendars)) setOpt(CHANNEL.name + '_CALENDARS', calendars = [{ src:'cmjrl0iaci7in72n3rem95qaec@group.calendar.google.com', color:'2952A3' } ]); //set the default calendar if not already
